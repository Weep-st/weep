-- ==============================================================================
-- WEEP - RPC UNIFICADO PARA CREACIÓN DE PEDIDOS (VERSIÓN FINAL)
-- Incluye soporte para Cupones, Promociones, Créditos y Wallet.
-- ==============================================================================

-- 1. Asegurar columnas necesarias en pedidos_general
...
BEGIN
    BEGIN
        ...
        INSERT INTO pedidos_general (
            ...
            cupon_id, descuento_cupon, promociones_aplicadas, ganancia_credito
        ) VALUES (
            ...
            COALESCE(p_promociones_aplicadas, '[]'::jsonb), 
            COALESCE(p_ganancia_credito, 0)
        );

        -- Actualizar flag de primer pedido del usuario (para promos futuras)
    ...
    EXCEPTION WHEN OTHERS THEN
        RAISE EXCEPTION 'Error crítico en creación de pedido unificado: %', SQLERRM;
    END;
